            ...
            <div className="content__body--group">
              ...
              <div className="content-text">
                <span>
                  ...
                  lorem. Pretium condimentum pellentesque gravida id etiam sit sed arcu euismod.
              ...
              <div className="content-text">
                <ul>
                  ...
                  <li>
                    unordered list itemunordered list itemunordered list itemunordered list
                    itemunordered list itemunordered list itemunordered list itemunordered list item
                  </li>
                  <li>unordered list item</li>
                </ul>
              </div>
