            ...
            <div className="content__header">
              <div className="row">
                <div className="col-xl-12 col-md-12 content__header--title">
                  <span className="content__header--title-text">Thông tin tài khoản</span>
                </div>
              </div>
            </div>
            ...
            <div className="content__bodyAccount">
                ...
                <div className="bodyAccount--item-Info">
                  ...
                  <div className="bodyAccount--item-menu">
                    <ul className="bodyAccount__MenuList">
                      <li
                        className="bodyAccount__MenuList--item text--heading "
                        onClick={() => onChangeDisplay(display ? !display : display)}
                      >
                        Tổng quan
              ...
              <div className="content__bodyAccount--item content__bodyAccount--item-text">
                <div className="content__bodyAccount--heading">
                  <div className="row">
                    <div className="col-xl-9 text--heading">Thông tin tài khoản</div>
                  ...
                  <div className="content__bodyAccount--information">
                    ...
                    <div className="information--Password information--item">
                      <div className="row">
                        ...
                        <div className="col-xl-7 ">
                          <div className="securityChange">*******************</div>
                        </div>
                  ...
                  <div className="row tour--detail-group-item">
                    <div className="row">
                      ...
                      <div className="col-xl-3">
                        <button className="detail-btnSave detail-text">Hủy</button>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-xl-10">
                        <div className="notificationUser-info">
                          <div className="text-heading14">Cám ơn bạn đã đồng hành</div>
                  ...
                  <div className="list-item-content">
                    <div className="list--content-text">
                      <span>
                        ...
                        1500s, including versions of Lorem Ipsum.
                      </span>
                    </div>
                  </div>
                </div>
