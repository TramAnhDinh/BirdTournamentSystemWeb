      ...
      <div className="col-12 col-sm-6 col-md-3 col-lg-3 p-2 text-md-start text-center">
        ...
        <ul className="list-unstyled pe-md-3 px-1">
          ...
          <li className="font-inter">
            @Copy-right - 2023 : Bản quền thuộc về công ty Tournament Bird.
          </li>
    ...
    <div className={'row w-100 my-5 bg way-of-bird-bg mx-0'}>
      ...
      <div className={'py-5'}>
        <div className={'col-12 my-5'}>
          <p className={'fw-bold fs-5 text-center font-inter'}>
            Cuộc hành trình của Bird Tournament
          </p>
        </div>
        ...
        <div className={'col-10 mx-auto py-5'}>
          <div className={'row'}>
            <div className={'col-12 col-md-6 position-relative'}>
              <div
                className={
                  'w-md-50 right--100 bottom-100 mx-auto position-md-absolute bg-white rounded p-3 d-flex flex-column align-items-center justify-content-center'
                }
              >
                ...
                <div className={'w-100'}>
                  <p
                    className={'text-info text-end my-0'}
                    style={{ fontSize: '10px', lineHeight: 0.6 }}
                  >
                    John Doe
                  </p>
                  <p className={'text-black text-end my-0'} style={{ fontSize: '10px' }}>
...
const BenefitOfBirdTournament = () => {
  return (
    <div className={'row w-100 m-0 bg benefit-of-tournament py-5 position-relative'}>
      <p
        className={'fs-3 fw-bold text-center w-100 position-absolute'}
        style={{ top: '80px', zIndex: 100 }}
      >
        Benefits of Bird Tournament
      </p>
      {/*    layer*/}
      <div className={'w-100 d-none d-md-block position-absolute h-100 benefit-layer-resp-bottom'}>
        <div className={'row  mx-auto'} style={{ width: '90%' }}>
          <div className={'col-6 d-flex flex-column justify-content-center align-items-center'}>
            ...
            <p className={'fw-light font-inter w-25 text-center'}>
              Tiết kiếm 90% thời gian tìm giải đấu
            </p>
          </div>
          <div className={'col-6 d-flex flex-column justify-content-center align-items-center'}>
            <img src={image8} alt={'image'} width={100} height={100} />
            <p className={'fw-light font-inter w-25 text-center'}>
              Giúp chim cưng phát triển toàn diện hơn
            </p>
          </div>
        </div>
        <div className={'row mx-auto'} style={{ width: '70%' }}>
          ...
          <div
            className={
              'col-12 col-md-8 d-flex flex-column justify-content-center align-items-center'
            }
          >
            <div className={'row w-100 justify-content-between'}>
              <div className={'col-6 d-flex justify-content-center align-items-center flex-column'}>
                <img src={image7} alt={'image'} width={50} height={50} />
                <p className={'fw-light font-inter  w-50 text-center mt-3'}>
                  Kết nối bạn bè bốn phương
                </p>
              </div>
              <div className={'col-6 d-flex justify-content-center align-items-center flex-column'}>
                <img src={image8} alt={'image'} width={80} height={80} />
                <p className={'fw-light  font-inter w-50 text-center'}>
                  Giúp tăng giá trị sở hữu của chim
                </p>
              </div>
            </div>
          </div>
      ...
      <div className={'w-100 h-100 d-flex justify-content-center align-items-center'}>
        <div
          className={
            'border circle-resp d-flex border-2 justify-content-center align-items-center rounded-circle'
          }
        >
          <div
            style={{ width: '80%', height: '80%' }}
            className={
              'border border-2 d-flex justify-content-center align-items-center rounded-circle'
            }
          >
            <div
...
const HotTournament = (props) => {
  return (
    <div className={'row w-100 py-5 m-0 px-1 bg hot-tournament-bg'}>
      <div
        className={
          'col-10 mx-auto rounded py-5 bg-black d-flex justify-content-center align-items-center'
        }
      >
      ...
      <div className={'col-10 d-flex justify-content-center align-items-center mx-auto my-5'}>
        <div className={'row w-100'}>
          <div
            className={
              'col-12 col-sm-6 d-flex flex-column justify-content-center align-items-center col-md-4 text-center px-5 px-md-3 px-lg-5'
            }
          >
            <img
              src={hotTournament1}
          ...
          <div
            className={
              'col-12 col-sm-6 col-md-4 d-flex flex-column justify-content-center align-items-center text-center px-5 px-md-3 px-lg-5'
            }
          >
            <img
              src={hotTournament2}
